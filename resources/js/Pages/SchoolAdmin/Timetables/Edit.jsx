...
export default function Edit({ school, timetable, classes, subjects, teachers }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('timetables.update', [school, timetable]));
    };
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            <h1 className="text-2xl font-bold">Edit Timetable Entry</h1>
